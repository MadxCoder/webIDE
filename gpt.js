(function() {
	...
	var ma = function(a, b) {
		...
		na = function(a) {
			for (var b = v(219), c = b.length, d = Array(c), e = q(b) ? b.split("") : b, f = 0; f < c; f++) f in e && (d[f] = a.call(void 0, e[f], f, b));
			return d
		},
		oa = function(a, b) {
			a: {
	...
	var va = function(a) {
			return a instanceof A && a.constructor === A && a.f === ua ? a.b : "type_error:TrustedResourceUrl"
		},
		ua = {};
	var C = function() {
		this.l = "";
	...
	var Fa = function(a, b, c) {
			var d = !1;
			void 0 === c || c || (d = Ca());
			return !d && !Da() && (c = Math.random(), c < b) ? (c = Ea(), a[Math.floor(c * a.length)]) : null
		},
		Ea = function() {
	...
	var J = function() {},
		...
		L = function(a, b, c, d) {
			...
			a: {
				if (b = a.a.length) {
					--b;
					var e = a.a[b];
					if (e && "object" == typeof e && "array" != la(e) && !(Qa && e instanceof Uint8Array)) {
						a.h = b - a.f;
						a.c = e;
						break a
					}
			...
			a.J = {};
			if (c)
				for (b = 0; b < c.length; b++) e = c[b], e < a.h ? (e += a.f, a.a[e] = a.a[e] || K) : (Ra(a), a.c[e] = a.c[e] || K);
			if (d && d.length)
				for (b = 0; b < d.length; b++) Sa(a, d[b])
		},
		K = [],
		Ra = function(a) {
			var b = a.h + a.f;
		...
		Xa = function(a, b) {
			a.b || (a.b = {});
			if (!a.b[2]) {
				for (var c = Ua(a, 2), d = [], e = 0; e < c.length; e++) d[e] = new b(c[e]);
				a.b[2] = d
			}
			b = a.b[2];
			b == K && (b = a.b[2] = []);
	...
	var pb = function(a, b) {
			...
			this.h = d;
			this.b = {};
			if (a = Za()) a = a.split(",") || [], u(a, function(a) {
		...
		sb = function() {
			var a = qb.g(),
				b = a.c[5];
			b && (delete a.c[5], u(b, function(b) {
				b = new ab(b);
				!Wa(b, kb, 3) && (b = rb(a, b)) && (a.h.push(b.getId()), (b = Xa(b, O)) && ob(b))
			}))
		},
		rb = function(a, b) {
			var c = Xa(b, cb),
			...
			try {
				...
				if (-1 != c.toLowerCase().indexOf("stylesheet")) var h = va(b);
					...
					if (b instanceof A) var n = va(b);
						...
						if (b instanceof C) var m = b instanceof C && b.constructor === C && b.F === wa ? b.l : "type_error:SafeUrl";
						else {
							if (b instanceof C) var l = b;
							else b = "object" == typeof b && b.c ? b.a() : String(b), xa.test(b) || (b = "about:invalid#zClosurez"), l = ya(b);
							m = l.a()
						}
						n = m
					}
	...
	var wb = /^\.google\.(com?\.)?[a-z]{2,3}$/,
		...
		T, U, V = function() {
			...
			var a = +new Date;
			T[1] && T[3] > a && 0 < T[2] || (T[1] = "", T[2] = -1, T[3] = -1, T[4] = "", T[6] = "");
		...
		Db = function(a) {
			"complete" == p.document.readyState || "loaded" == p.document.readyState || p.document.currentScript && p.document.currentScript.async ? Cb(3) : a()
		},
		Eb = 0,
		W = {
			i: function() {
		...
		Cb = function(a) {
			1E-5 > Math.random() && ub("https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err=" + a)
		};
	W.j = function() {
		if (!W.i()) {
			var a = p.document,
	...
	var Fb = function(a) {
		...
		Ib = function() {
			p.processGoogleTokenSync = p.processGoogleTokenSync || function(a, b) {
				return Gb(X, a, b)
			};
			Fb(X)
		},
		Gb = function(a, b, c) {
			...
			if (!d && a.D()) yb(".google.com") && (U[1] = ".google.com"), a.j();
				...
				var m = S.googleToken = S.googleToken || {},
					l = 0 == c && d && q(d) && !e && "number" == typeof f && 0 < f && "number" == typeof h && 0 < h && q(n);
				e = e && !a.i() && (!(T[3] >= +new Date) || "NT" == T[1]);
				var t = !(T[3] >= +new Date) && 0 != c;
				if (l || e || t) e = +new Date, f = e + 1E3 * f, h = e + 1E3 * h, Cb(c), m[5] = c, m[1] = d, m[2] = f, m[3] = h, m[4] = n, m[6] = b, V();
				if (l || !a.i()) {
					c = a.v();
	...
	Jb.prototype.b = function(a, b, c, d, e) {
		...
		p.error_rep_loaded || (b = p.document, a = b.createElement("script"), za(a, Ba(p.location.protocol + "//pagead2.googlesyndication.com/pagead/js/err_rep.js")), (b = b.getElementsByTagName("script")[0]) && b.parentNode && b.parentNode.insertBefore(a, b), p.error_rep_loaded = !0);
		return !1
	};
	var Lb = function(a, b) {
		...
		try {
			...
			if (!c.call(a, 420, d, .01, void 0, "gpt_exception")) throw d;
		}
	};
	var Mb = function(a) {
	...
	var sa = {
		3: [
			...
			[1, [
				[22321847],
				[21062060, [
					[null, null, null, [null, null, null, "25 25 25 25 25 25 25 25 25 25".split(" ")], null, 2]
				]],
				[22321848, [
					[null, null, null, [null, null, null, "50 50 50 50 50 50 50 50 50 50".split(" ")], null, 2]
				]],
				[22322161, [
			...
			[10, [
				[21062125],
				[21062137, [
					[null, 2, null, [null, 5E3]]
				]],
				[21062126, [
					[null, 2, null, [null, 1E3]]
				]],
				[21062136, [
					[null, 2, null, [null, 3E3]]
				]]
			]],
			[10, [
				[21061803],
	...
	var Rb = function(a) {
		var b = v(148) ? Za() : "";
		return (b = b && b.match(new RegExp("\\b(" + a.join("|") + ")\\b"))) ? b[0] : Fa(a, .001 * a.length)
	};
	(function(a) {
		var b = new Jb;
		Kb(b, function(a) {
		...
		Lb(b, function() {
			...
			if (d.evalScripts) d.evalScripts();
				...
				sb();
				f = b;
				if (h = Rb(["21061590", "21061591"])) "21061591" == h ? (I(173, Pb), I(174, Pb)) : I(163, h), v(152).push(h); - 1 != x.indexOf("Mobile") || I(194, v(225));
				h = v(150);
				V();
				yb(h) && (U[1] = h);
				...
				if (f = (f = f.performance) && f.now ? f.now() : null) f = {
					...
					type: 9,
					value: f
				}, e = e.google_js_reporting_queue = e.google_js_reporting_queue || [], 1024 > e.length && e.push(f);
				if (e = v(76)) var m = e;
				else {
					var l;
					e = "";
					...
					if (v(131)) m = "245", h = !0;
						...
						if (D) {
							...
							if (D == w || parseInt(m, 10) < parseInt(e, 10)) n = n[t.length - 1], f = "?v=" + n, I(163, n)
						}
					}
					h || (h = Rb(["21062293", "21062294"])) && "21062294" == h && (h = Date.now(), f = "?cb=" + h, I(163, h));
					e = Y + "//" + Z + "/gpt/pubads_impl_" + (l ? l : m || e) + ".js" + f;
					I(76, e);
					m = e
				}
				l = b.currentScript;
				if (!("complete" == b.readyState || "loaded" == b.readyState || l && l.async)) {
					l = "gpt-impl-" + Math.random();
					try {
						e = '<script id="' + l + '" src="' + m + '">\x3c/script>', Q(1, 17, !1) && vb() && (e += '<link rel="preconnect" href="' + Y + "//" + Z + '">'), b.write(e)
					} catch (fb) {}
					b.getElementById(l) && (d._loadStarted_ = !0, I(220, !1), Q(2, 4, 0) || Ib())
				}
				d._loadStarted_ || (Q(2, 4, 0) || Hb(), Q(1, 16, !1) && R(b, m, "preload", "script"), l = b.createElement("script"), l.src = m, l.async = !0, (b.head || b.body || b.documentElement).appendChild(l), Q(1, 17, !1) && vb() && R(b, Y + "//" + Z, "preconnect"), I(220, !0), d._loadStarted_ = !0)
			}
		})
	})();
